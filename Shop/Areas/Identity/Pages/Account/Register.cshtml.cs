        ...
        public async Task<IActionResult> OnPostAsync(IFormFile file, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (file != null)
                {
                    ...
                    user = new AppIdentityUser { UserName = Input.Email, Email = Input.Email, ImagePath = file.FileName };
                }
                else
                {
                    user = new AppIdentityUser { UserName = Input.Email, Email = Input.Email, ImagePath = "" };
                }
